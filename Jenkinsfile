	...
	echo '{"project": "'"70009411-9135-4bd4-8618-40d8cf252157"'", "bom": "'"$BOM_CONTENT_BASE64"'"}' > json_payload.json
     ...
     stage('dependencyTrackPublisher') {
	        ...
	        withCredentials([string(credentialsId: 'api_key', variable: 'api_key')]) {
                    dependencyTrackPublisher artifact: 'json_payload.json', projectId: '70009411-9135-4bd4-8618-40d8cf252157', projectName: 'demo-project', projectVersion: '1.0', synchronous: true, dependencyTrackApiKey: api_key ; 
		}
